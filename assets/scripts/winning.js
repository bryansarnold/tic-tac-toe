...
let winningRowMove = [[1,2,3],[4,5,6],[7,8,9]];

let winningColMove = [[1,4,7],[2,5,8],[3,6,9]];

let winningDiagMove = [[1,5,9],[3,5,7]];
...
let winningRowMove = function(player) {
  ...
  //        threeInARow([1]) ||
  //        threeInARow([2]);
return    threeInARow(boxNumber['1']), boxNumber['2']), boxNumber(['3'])) ||
